...
import { ZoomIn, ZoomOut, ChevronLeft, ChevronRight, RotateCw, Loader2, Download } from 'lucide-react';
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-3 py-2 pl-10 flex items-center justify-between">
        ...
        {/* Download Button - only show if analysis is complete and highlights exist */}
        {highlights.length > 0 && onDownloadHighlighted && (
          <div className="flex items-center gap-2">
