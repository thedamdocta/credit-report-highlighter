        ...
        <div className="relative flex flex-col">
          ...
          >
            <Textarea
              ...
              className="w-full rounded-xl rounded-b-none px-4 py-3 bg-black/5 border-none text-black placeholder:text-black/70 resize-none focus-visible:ring-0 leading-[1.2]"
              ref={textareaRef}
              onKeyDown={(e) => {
